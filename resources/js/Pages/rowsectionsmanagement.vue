<template>
    <app-layout :settings="settings" title="Dashboard">
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">Row sections management</h2>
        </template>

        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden sm:rounded-lg">
                    <adminRowSectionVue v-if="licence != null && licence.available" :access_right="licence.access_right"
                        :asset="asset" :rowssections="rowssections"></adminRowSectionVue>
...
import adminRowSectionVue from './content/includes/admin/adminRowSection.vue'
